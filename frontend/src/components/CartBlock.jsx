   ...
   return (
      <div class="cart-block">
         <div class="cart-block__container">
            <div class="cart-block__pizza">
               <img src="https://dodopizza.azureedge.net/static/Img/Products/f035c7f46c0844069722f2bb3ee9f113_584x584.jpeg" alt="" class="cart-block__img-pizza" width={80} height={80} />
               <div class="cart-block__text">
                  <h3 class="cart-block__tittle">Чізбургер-піца</h3>
                  <p class="cart-block__description">тонке тісто</p>
               </div>
            </div>
            <div class="cart-block__counted-price-delete">
               <div class="cart-block__counter">
                  ...
                  <span class="cart-block__number-of-pizzas">2</span>
               ...
               <span class="cart-block__price">500 ₴</span>
